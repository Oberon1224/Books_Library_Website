...
from .query_for_views.query_view_favorites import query_create, query_select_all, query_select_for_user
    ...
    """ Класс является моделью представления state_favorites.
        ...
        SQL-запрос создания представления filter (self.create_query): 
            ..  code-block:: sql
                ...
                CREATE VIEW IF NOT EXISTS state_favorites AS 
    ...
    def select_for_user(self, login: str) -> list[list[str]]:
        ...
        SQL-запрос (self.query_select_for_filter_all): 
            ..  code-block:: sql
                ...
                SELECT * FROM state_favorites WHERE login = ?:     
        ...
        try:
            ...
            print('Ошибка выполнения запроса select_for_user в классе ViewFavorites!')  